...
/// This can be used to test both Android and iOS implementations
...
class _PlatformIntegrationTestState extends State<PlatformIntegrationTest> {
  ...
  @override
  Widget build(BuildContext context) {
    // Detect platform using dart:io instead of Theme.of(context)
    if (Platform.isIOS) {
      _platform = 'iOS';
  ...
  Future<void> _testLogin() async {
    ...
    try {
      // Test with dummy credentials - replace with real ones for testing
